...
public class HodComplaintDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hod_complaint_details);
    ...
    private void startDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HodComplaintDetails.this);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(subject)){
                    Toast.makeText(HodComplaintDetails.this, "Please type the subject of your complaint", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(complaint)){
                    Toast.makeText(HodComplaintDetails.this, "Please type your complaint", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    complaints.push().setValue(newComplaint).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            dialog.dismiss();
                            Toast.makeText(HodComplaintDetails.this, "Complaint sent", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(HodComplaintDetails.this, HoDsHome.class));
                        ...
                        public void onFailure(@NonNull Exception e) {
                            dialog.dismiss();
                            Toast.makeText(HodComplaintDetails.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
