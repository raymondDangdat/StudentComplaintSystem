...
import comq.example.raymond.studentcomplaintsystem.Common.Common;
...
public class DeansHome extends AppCompatActivity
    ...
    private TextView txt_faculty_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deans_home);
        ...
        txt_faculty_name = findViewById(R.id.faculty_name);

        staff = FirebaseDatabase.getInstance().getReference().child("complaintSystem").child("staff").child("deans");
...
//        });
    ...
    private void loadComplaints(String faculty) {

        FirebaseRecyclerOptions<ScomplaintModel> options = new FirebaseRecyclerOptions.Builder<ScomplaintModel>()
                .setQuery(complaints.orderByChild("faculty").equalTo(faculty), ScomplaintModel.class)
                .build();
            ...
            protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull ScomplaintModel model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent complaintDetail = new Intent(DeansHome.this, DeansComplaintDetails.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.deans_home, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_complaints) {
            ...
            mAuth.signOut();
            finish();
            Intent signoutIntent = new Intent(DeansHome.this, LoginActivity.class);
