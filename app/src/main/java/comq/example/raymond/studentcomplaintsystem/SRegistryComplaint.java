...
public class SRegistryComplaint extends AppCompatActivity {
    private Toolbar registryToolbar;
    ...
    private String name, matNo, faculty, department, phone, level = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sregistry_complaint);
        ...
        registryToolbar = findViewById(R.id.registry_complaint_toolbar);
        setSupportActionBar(registryToolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Registry Complaint");
    ...
    private void complaint_dialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SRegistryComplaint.this);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(subject)){
                    Toast.makeText(SRegistryComplaint.this, "Please type the subject of your complaint", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(complaint)){
                    Toast.makeText(SRegistryComplaint.this, "Please type your complaint", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    complaints.push().setValue(newComplaint).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            dialog.dismiss();
                            Toast.makeText(SRegistryComplaint.this, "Complaint sent", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(SRegistryComplaint.this, SRegistryComplaint.class));
                        ...
                        public void onFailure(@NonNull Exception e) {
                            dialog.dismiss();
                            Toast.makeText(SRegistryComplaint.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
